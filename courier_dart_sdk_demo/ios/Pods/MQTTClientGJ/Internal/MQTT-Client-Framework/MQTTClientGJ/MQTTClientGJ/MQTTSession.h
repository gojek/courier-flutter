...
extern NSString * const MQTTClientcourier;
...
typedef NS_ENUM(NSInteger, MQTTSessionError) {
    ...
    MQTTSessionErrorConnectTimeout = 101,
    MQTTSessionErrorInactivityTimeout = 102,
    MQTTSessionErrorReadTimeout = 103
};
...
@property (nonatomic) BOOL shouldEnableActivityCheckTimeout;
@property (nonatomic) BOOL shouldEnableConnectCheckTimeout;

@property (nonatomic) NSTimeInterval activityCheckTimerInterval;
@property (nonatomic) NSTimeInterval connectTimeoutCheckTimerInterval;

@property (nonatomic) NSTimeInterval connectTimeout;
@property (nonatomic) NSTimeInterval connectTimestamp;

@property (nonatomic) NSTimeInterval inactivityTimeout;
@property (nonatomic) NSTimeInterval readTimeout;
@property (nonatomic) NSTimeInterval fastReconnectTimestamp;
@property (nonatomic) NSTimeInterval lastInboundActivityTimestamp;
@property (nonatomic) NSTimeInterval lastOutboundActivityTimestamp;
