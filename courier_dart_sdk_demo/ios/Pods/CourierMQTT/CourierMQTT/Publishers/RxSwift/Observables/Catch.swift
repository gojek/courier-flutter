...
extension ObservableType {
     ...
     **This could potentially create an infinite sequence.**
     ...
     - seealso: [retry operator on reactivex.io](http:
...
private final class CatchSequenceSink<Sequence: Swift.Sequence, Observer: ObserverType>: TailRecursiveSink<Sequence, Observer>,
