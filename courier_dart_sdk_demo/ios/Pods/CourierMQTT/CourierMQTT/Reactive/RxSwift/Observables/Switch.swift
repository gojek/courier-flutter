...
extension ObservableType where Element: ObservableConvertibleType {
    /**
     ...
     - seealso: [switch operator on reactivex.io](http:
...
private class SwitchSink<SourceType, Source: ObservableConvertibleType, Observer: ObserverType>: Sink<Observer>,
...
private final class SwitchSinkIter<SourceType, Source: ObservableConvertibleType, Observer: ObserverType>: ObserverType,
                                                                                                           LockOwnerType,
