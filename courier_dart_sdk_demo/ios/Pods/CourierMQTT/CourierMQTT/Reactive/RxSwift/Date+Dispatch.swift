...
extension DispatchTimeInterval {
    var convertToSecondsFactor: Double {
        switch self {
        case .nanoseconds: return 1000000000.0
        case .microseconds: return 1000000.0
    ...
    func map(_ transform: (Int, Double) -> Int) -> DispatchTimeInterval {
        switch self {
        case let .nanoseconds(value): return .nanoseconds(transform(value, 1000000000.0))
        case let .microseconds(value): return .microseconds(transform(value, 1000000.0))
